                ...
                <div class="col-sm-9 col-md-6 form-center">
                    <form class="form-horizontal text-center" action="{{ route('books.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="string" name="author" class="form-control" id="author">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="publisher">Publisher</label>
                            <div class="col-md-8">
                                <input type="string" name="publisher" class="form-control" id="publisher">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="string" name="subjects" class="form-control" id="subjects">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="image_path">Image Path</label>
                            <div class="col-md-8">
                                <textarea name="image_path" id="image_path" cols="30" rows="10" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
